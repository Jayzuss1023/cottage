  ...
  const onDrop = useCallback(
    async (acceptedFiles: File[]) => {
      ...
      try {
        ...
        // Replace plceholders with actual uploaded images
        onChange([
          ...images,
                  ...
                  >
                    {(provided, snapshot) => (
                      ...
                      >
                        ...
                        {/* Uploading overloay */}
                        {image.isUploading && (
                          <div className="absolute inset-0 flex items-center justify-center bg-;lack/20">
                            <Loader2 className="h-6 w-6 text-white animate-spin" />
                          </div>
                        )}

                        {/* Controls overlay: Hover over image */}
                        {!image.isUploading && (
