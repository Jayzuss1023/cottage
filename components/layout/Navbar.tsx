...
export function Navbar() {
  ...
  // Dusable sticky header on pricing page to prevent z-index conflicts with Clerk's PricingTable
      ...
      <div className="container flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          >
            <Link
              href="/properties"
              className="px-4 py-2 text-sm font-medium text-muted-foreground rounded-lg hover:bg-accent transition-[color,background-color] duration-200"
            >
              Browse Properties
            </Link>
            <SignedIn>
            ...
            >
              <SheetHeader>
                <SheetTitle className="flex items-center gap-2">
                  ...
                  <span className="font-heading">Cottage</span>
                </SheetTitle>
              </SheetHeader>
              <nav
