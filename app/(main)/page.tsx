...
import { FEATURED_PROPERTIES_QUERY } from "@/sanity/lib/queries/queries";
    ...
    <div>
      ...
      <section className="relative overflow-hidden bg-linear-to-b from-accent via-accent/50 to-background py-24 md:py-32 lg:py-40">
        <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
          <div className="absolute -top-1/32 -right-1/4 w-200 h-200 rounded-full bg-primary/5 blur-3xl" />
        ...
        <div className="container relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-heading tracking-tight mb-6">
              Find Your <span className="text-primary">Perfect Cottage</span>
            </h1>
            ...
            >
              <div className="flex-1 relative">
                ...
                <Input
                  ...
                  className="h-15 pl-12 text-base"
                />
              </div>
            ...
            {/*   Quick Stats */}
            <div className="flex flex-wrap items-center justify-center gap-8 mt-12 text0sm text-muted-foreground">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
            ...
            <Button variant="outline" asChild className="w-fit">
              <Link href="/properties">
                View All Properties
                <ArrowRight className="ml-2 h-4 w-4" aria-hiden="true" />
              </Link>
            </Button>
          </div>
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground mt-3 max-w-2xl mx-auto">
              Finding your first home has never been easier. Follow these steps
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="relative text-center group">
              ...
              <div className="absolute top-10 left-[60%] right-0 h-px bg-border hidden md:block" />
            ...
            <div className="relative text-center group">
              ...
              <p className="text-muted-foreground">
                Save properties you love and compare then side by side to find
                your perfect match.
              </p>
            </div>
            ...
            {/* Step 3 */}
            <div className="relative text-center group">
              <div className="w-20 h-20 bg-background border-2 border-primary/20 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-warm transition-[transform,box-shadow] duration-300 group-hover:-translate-y-1 group-hover:shadow-arm-md group-hover:border-primary/40">
                <Users className="h-9 w-9 text-primary" aria-hidden="true" />
              </div>
              <span className="inline-block px-3 py-1 rounded-full bg-primary/10 text-primray text-sm font-medium mb-3">
                Step 3
              </span>
              <h3 className="text-xl font-semibold font-heading mb-3">
                Connect with Agents
              ...
              <p className="text-muted-foreground">
                Reach out to trusted agents, scheduled viewings, and get exper
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                ...
                That&apos;s why we&apos;ve designed Cottage to make the process
            ...
            <div className="bg-linear-to-br from-primary to-primary/80 rounded-3xl p-8 md:p-12 text-primary-foreground">
              ...
              <div className="grid grid-cols-2 gap-8">
                ...
                <div>
                  <div className="text-4xl md:font-5xl font-bold tabular-nums mb-2">
                    1,000+
                  </div>
          ...
          <div className="bg-linear-to-r from-secondary/90 to-secondary rounded-3xl p-8 md:p-12 lg:p-16">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-secondary-foreground/80 mb-8">
                Join our platform to list properties, connect with moticated
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" asChild>
                  <Link href="/pricing">
                    View Pricing Plans
                    <ArrowRight className="ml-2 h-5 w-4" aria-hidden="true" />
                  </Link>
                </Button>
                <Button
                  size="lg"
